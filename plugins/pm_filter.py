...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if mkact:
            ...
            await query.message.edit_text('𝖲𝗂𝗆𝖾 𝖤𝗋𝗋𝗈𝗋 𝖮𝖼𝖼𝗎𝗋𝗋𝖾𝖽!!', parse_mode="md")
        return await query.answer('𝖲𝗁𝖺𝗋𝖾 𝖠𝗇𝖽 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖡𝗒 𝖬𝗈𝗏𝗂𝖾 𝖢𝗅𝗎𝖻')
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            fek = await message.reply_photo(photo="https://telegra.ph/file/c5f1489cc706063baf6d4.jpg", caption=cap, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(300)
            await fek.delete()
            await msg.delete()
    else:
        fuk = await message.reply_photo(photo="https://telegra.ph/file/14af383f7c4aa2915c8c5.jpg", caption=cap, reply_markup=InlineKeyboardMarkup(btn))
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply(f"𝖧𝖾𝗒 {query.from_user.first_name}, 𝖨 𝖢𝗈𝗎𝗅𝖽𝗇'𝗍 𝖥𝗂𝗇𝖽 𝖠𝗇𝗒𝗍𝗁𝗂𝗇𝗀 𝖱𝖾𝗅𝖺𝗍𝖾𝖽 𝖳𝗈 𝖳𝗁𝖺𝗍. 𝖢𝗁𝖾𝖼𝗄 𝖸𝗈𝗎𝗋 𝖲𝗉𝖾𝗅𝗅𝗂𝗇𝗀 & 𝖲𝖾𝗇𝖽 𝖳𝗁𝖾 𝖢𝗈𝗋𝗋𝖾𝖼𝗍 𝖮𝗇𝖾")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply_sticker(sticker="CAACAgUAAxkBAAEPAAFkYkJ0HDc7FDsPXc7Kn7FW2iy67lUAAqUEAAIHjBFWnGf5YCJdzK8jBA",
                    reply_markup=InlineKeyboardMarkup(btn))
